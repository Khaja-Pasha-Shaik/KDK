const events = {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const calculateDaysToTrip = () => {
      ...
      const tripDate = new Date('2024-01-23');
  ...
  function showTicketLinks() {
    ...
    var links = [
      ...
      { name: "Coimbatore to Hyderabad", url: "https://www.google.com/search?q=lunks+to+be+embedded&oq=lunks+to+be+embedded&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQABiiBDIHCAIQABiiBNIBCDU1MzBqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8" },
  ...
  function showDayWisePlan() {
    ...
    option1.value = "Day-1 [Coimbatore City]";
    ...
    const jsonData = [
        {
          ...
          "time": "Wish",
          "visitingPlace": "Isha Foundation",
          "description": "Isha Foundation in Coimbatore, founded by Sadhguru Jaggi Vasudev, is a global center for yoga and meditation, promoting well-being and environmental consciousness.",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-1 [Coimbatore City]",
        ...
        },
        {
          ...
          "description": "Coaker's Walk in Kodaikanal is a scenic walking trail along the edge of the hill, providing panoramic views of the surrounding hills, valleys, and the town below, making it a popular spot for leisurely strolls and photography.",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-3 [Kodaikanal Valley]",
          ...
          "description": "The Upper Lake View in Kodaikanal offers breathtaking vistas of the Kodaikanal Lake and its surroundings, providing a tranquil and beautiful setting for visitors to enjoy the natural beauty of the region.",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-3 [Kodaikanal Valley]",
          ...
          "description": "Pambar Falls in Kodaikanal is a picturesque waterfall surrounded by dense forests and rocks, creating a serene and refreshing escape for nature enthusiasts and tourists.",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-3 [Kodaikanal Valley]",
          ...
          "description": "Green Valley View in Kodaikanal, also known as Suicide Point, is a popular viewpoint offering stunning vistas of the Vaigai Dam and the lush, rolling hills, attracting tourists seeking panoramic views and natural beauty.",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-3 [Kodaikanal Valley]",
          ...
          "description": "Pillar Rocks in Kodaikanal are a set of three vertically aligned granite rocks that stand tall and offer a spectacular sight, surrounded by scenic landscapes, making it a famous tourist attraction for its unique geological formation.",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-3 [Kodaikanal Valley]",
          ...
          "description": "Devil's Kitchen, also known as Guna Cave, is a mysterious cave system in Kodaikanal, shrouded in local legends. It's a fascinating place for adventurers to explore, with narrow passages and an intriguing history, making it an offbeat attraction in the region.",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-3 [Kodaikanal Valley]",
          ...
          "description": "The Pine Forest in Kodaikanal, often used as a backdrop for movie shootings, features a dense expanse of pine trees, creating a serene and cinematic setting that attracts nature lovers and film enthusiasts alike.",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-3 [Kodaikanal Valley]",
          ...
          "description": "Moir Point in Kodaikanal is a scenic viewpoint that offers breathtaking vistas of the Perumal Peak and the lush landscape, providing a tranquil location for visitors to appreciate the natural beauty of the region.",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-3 [Kodaikanal Valley]",
          ...
          "description": "Bryant Park in Kodaikanal is a beautifully landscaped botanical garden known for its diverse collection of flowers, making it a delightful place for leisurely strolls and picnics amidst colorful floral displays.",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-3 [Kodaikanal Valley]",
          ...
          "description": "Kodaikanal Lake, commonly known as Kodai Lake, is a man-made, star-shaped lake in Kodaikanal, Tamil Nadu. It is a popular attraction for boating and leisurely walks along its scenic promenade, surrounded by lush greenery and charming views.",
          "status": "Yet to Visit"
        },
        {
          ...
          "description": "Gundar Falls is a picturesque waterfall in Kodaikanal, offering a serene natural setting for visitors to enjoy the cascading waters and the peaceful surroundings, making it a peaceful spot for relaxation and exploration.",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-4 [Kodaikanal Village]",
          ...
          "description": "Same as before one's [May or may not be open]",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-4 [Kodaikanal Village]",
          ...
          "description": "Its a view point, if time permits, we can visit palani temple the last day",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-4 [Kodaikanal Village]",
          ...
          "description": "A temple built in kerala style",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-4 [Kodaikanal Village]",
          ...
          "description": "Best view to see the step farming",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-4 [Kodaikanal Village]",
          ...
          "description": "Poombarai Murugan Temple, is a Hindu temple dedicated to Lord Murugan, a popular deity in Tamil Nadu. ",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-4 [Kodaikanal Village]",
          ...
          "description": "The Mannavanur Sheep Farm in Kodaikanal also includes a rabbit farm in addition to sheep farming. Visitors to the farm can not only see sheep but also have the opportunity to observe and interact with rabbits.",
          "status": "Yet to Visit"
        },
        {
          "dayNumber": "Day-4 [Kodaikanal Village]",
          ...
          "description": "Try zipp line and boating",
          "status": "Yet to Visit"
        },
        {
  ...
  function submitExpense(event) {
    ...
    if (name && amount && description) {
      ...
      fetch('https://script.google.com/macros/s/AKfycbzgK_5HWuM5OwDsXqb6hr253hklvR1jgm_oaRI4TCiSgtoCcY_KbI21NbRbpDe_moeX/exec', {
        method: 'POST',
        mode:'no-cors',
        credentials:'omit',
        redirect:'follow',
  ...
  const apiUrl = 'https://script.google.com/macros/s/AKfycbzgK_5HWuM5OwDsXqb6hr253hklvR1jgm_oaRI4TCiSgtoCcY_KbI21NbRbpDe_moeX/exec';
  ...
  function generateBotResponse(userInput) {
    ...
    if (inputText === 'hi' || inputText === 'hello') {
      ...
      response = "The actual trip starts on Jan 24th.<br>We will be leaving on 23rd Jan night to Coimbatore";
      appendBotMessage(response);
    } else if (inputText === 'when does the trip end?' || (userInput.includes('end') && userInput.includes('date'))) {
      response = "The trip ends on Jan 28th.<br> You will reach home on 29th i.e., Monday";
      appendBotMessage(response);
    } else if (inputText === 'tell me about kodaikanal' || (userInput.includes('about') && userInput.includes('kodaikanal'))) {
      response = "You know what, Kodaikanal is often referred to as the 'Princess of Hill Stations', is a popular hill station located in the Indian state of Tamil Nadu. It is known for its natural beauty, pleasant climate, and a variety of attractions that draw tourists from around the world.";
      appendBotMessage(response);
    } else if (inputText === 'i want to add an expense. what is clearing expense?' || (userInput.includes('expense') && userInput.includes('add'))) {
      response = "This works with a clearing algo, very simple instead splitting the expense before hand, here you should remember if someone is involved in the spend. Appreciate if someone can rewrite the Algorithm, basically to use split between the people who are actually involved. Or an easy way could be give dropdown to user, to select who are involved in the expense.";
      appendBotMessage(response);
    } else if (inputText === 'what to shop in kodaikanal?' || userInput.includes('shop')) {
      response = "Ooty and Kodai both are almost same continuing their rich legacy of growing tea. Interested can but Tea or many stores that offer hand made chocolates";
      appendBotMessage(response);
    } else if (inputText === 'how many pair of clothes should i carry?' || userInput.includes('clothes')) {
      response = "It is recommended to carry only 4 pairs with 1 night wear and a sweater/thermal. Rest things you can tick off as you go following the Travel Checklist";
      appendBotMessage(response);
    } else if (inputText === 'essentials to carry with me, all the time?' || userInput.includes('carry')) {
      response = "Be responsible for your valuables. Sunscreen, a water bottle, cause plastic is banned. Or else be ready to spend 60 bucks per litre, and keep the glass bottle";
      appendBotMessage(response);
    } else if (inputText === 'why are we uploading tickets open to a site. can someone access them?' || userInput.includes('access')) {
        response = "Dont worry. They work with google share, and I will share only with you guys.";
        appendBotMessage(response);
    }else if (inputText === 'i want to opt out from rapid notification system' || userInput.includes('opt out')) {
        response = "I am going to send out emails starting from Nov 14th, you will get an email from a scheduler daily regarding the trip updates. And all important changes to visiting place addition, change in plan.. You can opt out by replying to that email on Nov 14th and there after";
        appendBotMessage(response);
  ...
  function showBotOptions() {
    const options = [
      ...
      "I want to add an expense. What is Clearing expense?",
      "Give me train number to track on WhereIsMyTrain App?",
      "Tell me about Kodaikanal",
      "What to shop in kodaikanal?",
      "Why are we uploading tickets open to a site. Can someone access them?",
      "Essentials to carry with me, all the time?",
      "I want to opt out from Rapid Notification System",
    ];
  ...
  async function generateAndShowExpenseReport() {
    ...
    const pdfDefinition = {
      content: [
        { text: 'Expense Report: Kodaikanal Trip\n\n', style: 'header' },
        {
          text: `Dear ${selectedParticipant},\n
        We hope this message finds you well. And wishing that you are enjoying the trip to Kodaikanal, we would like to provide you with an overview of the expenses incurred during the journey. Your participation contributed to a memorable experience, and we appreciate your involvement.
  ...
  function showCheckList() {
    ...
    const categories = {
        "Travel/Personal Documents": ["Aadhar Card[Original]", "Driving License[Original]-Mandatory in case we think to rent a car"],
        "Health and Safety": ["Tablets(If Any)", "Balm", "Cofsils"],
        "Money and Banking": ["Sufficient Cash in Hand", "Cards if you want to Carry"],
        "Electronics": ["Headphones", "Mobile Charger"],
        "Personal Care and Hygiene": ["Sun screen", "Toothbrush and toothpaste","Shampoo","Soap or body wash","Comb","Lip Balm","Moisturizer"],
        "Clothing and Accessories": ["Swimwear", "Sun Glasses","Cap/Hat","Comfortable walking shoes","Sweaters", "Head bands/Ear Covers"],
        "Miscellaneous": ["Reusable water bottle"],
    };
